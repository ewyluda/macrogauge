...
npm test           # vitest — client math (since/reweight/realwage/quiltRows/dcEscalation)
npm run e2e        # Playwright smoke — 27 routes / 32 e2e tests, zero console errors
```
